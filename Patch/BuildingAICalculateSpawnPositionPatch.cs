...
//{
//    [HarmonyPatch]
//    class BuildingAICalculateSpawnPositionPatch
//    {
//        public static MethodBase TargetMethod()
//        {
//            return typeof(BuildingAI).GetMethod("CalculateSpawnPosition", BindingFlags.Public | BindingFlags.Instance, null, new Type[] { typeof(ushort), typeof(Building).MakeByRefType(), typeof(Randomizer).MakeByRefType(), typeof(VehicleInfo), typeof(Vector3).MakeByRefType(), typeof(Vector3).MakeByRefType()}, null);
//        }
